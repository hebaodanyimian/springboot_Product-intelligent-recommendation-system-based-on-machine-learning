...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    <el-form
      ...
      label-width="80px"
    >
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="商品种类" prop="shangpinzhonglei">
            <el-input  v-model="ruleForm.shangpinzhonglei" 
                placeholder="商品种类" clearable :readonly=" false  ||ro.shangpinzhonglei"></el-input>
          </el-form-item>
